...
repositories, please report it to us using the [GitHub Private vulnerability reporting tool](https://github.com/statisticsnorway/fiks-protokoll-json-schemas/security/advisories).
